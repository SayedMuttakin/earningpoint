...
const SectionHeader = ({ title, icon: Icon, description }) => (
  <motion.div 
    ...
    className="mb-8 flex flex-col items-center text-center max-w-2xl mx-auto"
  >
...
const InfoCard = ({ item, index }) => (
  <motion.div
    ...
    className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group flex flex-col sm:flex-row items-start gap-4 sm:gap-6"
  >
...
const TermsPrivacyPage = ({ onBack }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 flex flex-col pb-24 font-sans relative">
      {/* Sticky Header with Max 7xl Constraint */}
